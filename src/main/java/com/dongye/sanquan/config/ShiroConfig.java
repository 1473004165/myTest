...
import com.dongye.sanquan.security.realm.MbRealm;
import com.dongye.sanquan.security.realm.ShiroRealm;
...
public class ShiroConfig {
    ...
    @Bean
    public MbRealm mbRealm(){
        MbRealm mbRealm = new MbRealm();
        mbRealm.setCredentialsMatcher(hashedCredentialsMatcher());
        return mbRealm;
    }
